...
input_file = '../inputs_sheet/steady/ref_trough_steady_10cm.hdf5'
scale_functions = ScaleFunctions(input_file,  4.65e-3,  4.65e-3, u_b_max = 100.0)
...
model_inputs['out_dir'] = 'out_trough_sliding_only_hr_10cm/'
