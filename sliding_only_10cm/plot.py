...
pt1 = PlotTools('out_trough_sliding_only_hr_10cm/out.hdf5')
pt2 = PlotTools('out_trough_sliding_only_hr_10cm1/out.hdf5')
pt3 = PlotTools('out_trough_sliding_only_hr_10cm2/out.hdf5')
