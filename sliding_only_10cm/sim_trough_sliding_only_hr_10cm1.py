...
input_file = '../inputs_sheet/steady/ref_trough_steady_10cm1.hdf5'
scale_functions = ScaleFunctions(input_file, 5.2e-3, 5.2e-3, u_b_max = 100.0)
...
model_inputs['out_dir'] = 'out_trough_sliding_only_hr_10cm1/'
