"""
Gammut of low melt lag time tests. Trough bed. High melt. 
"""
...
input_file = '../inputs_sheet/steady/trough_steady_high.hdf5'
k_min = 5e-5
k_max = 5e-3
...
for b in lag_times:
  scale_functions.b = b
  name = names[i]
  model_inputs['out_dir'] = 'lag_trough_high/' +  name
  model_inputs['checkpoint_file'] = 'lag_trough_high_' + name
