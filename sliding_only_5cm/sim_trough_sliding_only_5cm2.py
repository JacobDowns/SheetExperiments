...
input_file = '../inputs_sheet/steady/ref_trough_steady_5cm2.hdf5'
scale_functions = ScaleFunctions(input_file, 2.1e-2, 2.1e-2, u_b_max = 100.0)
...
model_inputs['out_dir'] = 'out_trough_sliding_only_hr_5cm2/'
