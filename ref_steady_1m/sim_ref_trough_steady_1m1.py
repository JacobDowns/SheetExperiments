...
model_inputs['input_file'] = '../inputs_sheet/steady/ref_trough_steady_1m1.hdf5'
model_inputs['out_dir'] = 'out_ref_trough_steady_1m1/'
...
model.write_steady_file('../inputs_sheet/steady/ref_trough_steady_1m1')
