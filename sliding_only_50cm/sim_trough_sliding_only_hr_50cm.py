...
input_file = '../inputs_sheet/steady/ref_trough_steady_50cm.hdf5'
scale_functions = ScaleFunctions(input_file, 6.2e-4, 6.2e-4, u_b_max = 100.0)
...
model_inputs['out_dir'] = 'out_trough_sliding_only_hr_50cm/'
