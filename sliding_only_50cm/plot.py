...
pt1 = PlotTools('out_trough_sliding_only_hr_50cm/out.hdf5')
pt2 = PlotTools('out_trough_sliding_only_hr_50cm1/out.hdf5')
pt3 = PlotTools('out_trough_sliding_only_hr_50cm2/out.hdf5')
